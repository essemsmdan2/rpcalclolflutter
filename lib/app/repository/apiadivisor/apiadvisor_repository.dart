...
class ApiAdvisorRepository implements IApiAdvisor {
  final IClientHttp dioHttpService = DioHttpService();
  @override
  Future<ApiAdvisorModel> getTime() async {
    final json = await dioHttpService.get(
        'http://apiadvisor.climatempo.com.br/api/v1/anl/synoptic/locale/BR?token=dc7f820c084aa2d0d3d08a7a8845255c');
